...
def print_stats(hands):
    ...
    print('Hand depth')
    print('Preflop: {}'.format(len(filter(lambda h: len(h.flop) == 0, hands))))
    print('Flop: {}'.format(len(filter(lambda h: len(h.flop) > 0 and len(h.turn) == 0, hands))))
    print('Turn: {}'.format(len(filter(lambda h: len(h.turn) > 0 and len(h.river) == 0, hands))))
    print('River: {}'.format(len(filter(lambda h: len(h.river) > 0, hands))))
